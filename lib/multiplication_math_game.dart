...
class MultiplicationMathGamePage extends StatefulWidget {

  int difficulty, noOfQuestions;

  MultiplicationMathGamePage(
      {Key key,
...
class MathGameView extends State<MultiplicationMathGamePage> {
      ...
      setState(() {
        ...
        if (difficulty == 1) {
          ...
          if (answerChoice == 1) {
            ...
            do {
              choiceThree = (random.nextInt(99) + 1);
            } while (choiceThree == choiceOne ||
                choiceThree == choiceTwo ||
          ...
          if (answerChoice == 1) {
            choiceOne = numberOne * numberTwo;
            do {
              choiceTwo = (random.nextInt(999) + 1);
            } while (choiceTwo == choiceOne);

            do {
              choiceThree = (random.nextInt(999) + 1);
            } while (choiceThree == choiceOne || choiceThree == choiceTwo);

            do {
              choiceFour = (random.nextInt(999) + 1);
            } while (choiceFour == choiceOne ||
                choiceFour == choiceTwo ||
                choiceFour == choiceThree);
          } else if (answerChoice == 2) {
            choiceTwo = numberOne * numberTwo;
            do {
              choiceOne = (random.nextInt(999) + 1);
            } while (choiceOne == choiceTwo);
            ...
            choiceFour = numberOne * numberTwo;
            do {
              choiceOne = numberOne + (random.nextInt(99) + 1);
            } while (choiceOne == choiceFour);
          ...
          if (answerChoice == 1) {
            choiceOne = numberOne * numberTwo;
            do {
              choiceTwo = (random.nextInt(9999) + 1);
            } while (choiceTwo == choiceOne);

            do {
              choiceThree = (random.nextInt(9999) + 1);
            } while (choiceThree == choiceOne || choiceThree == choiceTwo);

            do {
              choiceFour = (random.nextInt(9999) + 1);
            } while (choiceFour == choiceOne ||
                choiceFour == choiceTwo ||
                choiceFour == choiceThree);
          } else if (answerChoice == 2) {
            choiceTwo = numberOne * numberTwo;
            do {
              choiceOne = (random.nextInt(9999) + 1);
            } while (choiceOne == choiceTwo);
