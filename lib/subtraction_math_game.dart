...
class SubtractionMathGamePage extends StatefulWidget {

  int difficulty, noOfQuestions;

  SubtractionMathGamePage(
      {Key key,
...
class MathGameView extends State<SubtractionMathGamePage> {
